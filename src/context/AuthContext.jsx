...
import { AuthContext } from '../../context/AuthContext'; // Adjust path if needed based on your folder structure

export default function Navbar() {
    const [isOpen, setIsOpen] = useState(false);
    const { user, logout } = useContext(AuthContext); // Pulling user and logout function from AuthContext
